...
function SCORMAPI13(options) {

  $.support.cors = true;
  
  // Jun 12, 2017
  // Change: Rename LMSCommi(t) to LMSFCommit throughout file; quick fix to prevent Elucidat SCORM API discovery function from determining this is the 1.2 API
  // TO-DO: Recommend separating 1.2 and 2004 API objects - multiple course authroing packages will not expect them in same file. Quick fix handles immediate need only.
  ...
  this.LMSFCommit = __bind(this.LMSFCommit, this);
...
SCORMAPI13.prototype.LMSInitialize = function() {
...
SCORMAPI13.prototype.LMSGetValue = function(element) {
...
SCORMAPI13.prototype.LMSSetValue = function(element, value) {  
...
SCORMAPI13.prototype.LMSFinish = function() {
...
//SCORM 1.2 RTE API LMSFCommit
SCORMAPI13.prototype.LMSFCommit = function() { 

    var result, _this = this;
    this.errorCode = "0";

    if (this.Initialized) {
      this.DoSetLog('In LMSFCommit');
...
SCORMAPI13.prototype.LMSGetLastError = function() {
  return this.errorCode;
};

SCORMAPI13.prototype.LMSGetErrorString = function(errNo) {
  switch (errNo) {
    case '0':
      return 'No error';
    case '101':
...
SCORMAPI13.prototype.LMSGetDiagnostic = function(errNo) {
  return this.LMSGetErrorString(errNo);
};

//SCORM 1.2 General API StoreData
SCORMAPI13.prototype.StoreData = function(data, storetotaltime) {
  var _this = this;
  var datastring = '';
  ...
  if (storetotaltime) {
      ...
      if (this.cmi.core.lesson_status == this.SCORM_NOT_ATTEMPTED) {
          data.core.lesson_status = this.SCORM_COMPLETED;
      }
...
SCORMAPI13.prototype.CollectData = function(data, parent) {
    var _this = this;
    var datastring = '';
...
SCORMAPI13.prototype.underscore = function(str) {
    str = String(str).replace(/.N/g,".");
    return str.replace(/\./g,"__");
}

SCORMAPI13.prototype.CloneObj = function(obj){
...
SCORMAPI13.prototype.AddTime = function(first, second) {
...
SCORMAPI13.prototype.TotalTime = function() {
...
SCORMAPI13.prototype.Initialize = function() {
    this.SCORM2004_errorCode = "0";
...
SCORMAPI13.prototype.GetValue = function(element) {  
...
SCORMAPI13.prototype.SetValue = function(element, value) {
...
SCORMAPI13.prototype.Terminate = function() {
    this.SCORM2004_errorCode = "0";
    if ((this.SCORM2004_Initialized) && (!this.SCORM2004_Terminated)) {
...
SCORMAPI13.prototype.Commit = function() {
...
SCORMAPI13.prototype.GetLastError = function() {
  return this.SCORM2004_errorCode;
};

//SCORM 2004 RTE API this.GetErrorString
SCORMAPI13.prototype.GetErrorString = function(errNo) {
  switch (errNo) {
    case '0':
      return 'No error';
    case '101':
...
SCORMAPI13.prototype.GetDiagnostic = function() {
  return this.SCORM2004_diagnostic;
};

//SCORM 2004 General functions SCORM2004_DuplicatedPA
SCORMAPI13.prototype.SCORM2004_DuplicatedPA = function(element, parent, value) {
    var found = false;
...
SCORMAPI13.prototype.SCORM2004_DuplicatedID = function(element, parent, value) {
    var found = false;
    var elements = eval('this.' + parent + '._count');
    for (var n=0;(n < elements) && (!found);n++) {
...
SCORMAPI13.prototype.SCORM2004_AddTime = function(first, second) {
    var timestring = 'P';
...
SCORMAPI13.prototype.SCORM2004_TotalTime = function() {
...
SCORMAPI13.prototype.SCORM2004_CloneObj = function(obj){
    if(obj == null || typeof(obj) != 'object') {
        return obj;
    }
...
SCORMAPI13.prototype.SCORM2004_CollectData =  function(data, parent) {
    var datastring = '';
...
SCORMAPI13.prototype.SCORM2004_StoreData = function(data, storetotaltime) {
...
SCORMAPI13.prototype.SCORM2004_CRcheckValueNodes = function(element, interactiontype, nodes, value, errorCode) {
...
SCORMAPI13.prototype.SCORM2004_CRremovePrefixes = function (node) {
...
SCORMAPI13.prototype.Ping = function() {

};

SCORMAPI13.prototype.PopupError = function(msg) {
   $("<p>"+msg+'</p>' ).dialog({
      title : 'Error',
      modal: true,
        buttons: {
...
SCORMAPI13.prototype.LeavedPage = function() {
  
};

SCORMAPI13.prototype.clear = function() {
  this.data = {
...
SCORMAPI13.prototype.open = function(session_id, url) {
  this.setSessionId(session_id);
  return window.open(url);
};

SCORMAPI13.prototype.setSessionId = function(session_id) {
  this.options.obid = session_id;
  return this.clear();
};

SCORMAPI13.prototype.DoSetLog = function(log) {
  console.log(log);
};
