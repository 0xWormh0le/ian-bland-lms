                  ...
                  <tbody style="box-sizing: border-box;">
                    <tr style="box-sizing: border-box;">
                      ...
                      <td class="cell c1776" style="box-sizing: border-box; width: 70%; vertical-align: middle;" width="70%" valign="middle">
                        <div class="c1144" style="box-sizing: border-box; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px; font-size: 17px; font-weight: 300;">@PORTAL @COMPANY
                        </div>
                      </td>
                    </tr>
                  </tbody>
                          ...
                          <tbody style="box-sizing: border-box;">
                            <tr style="box-sizing: border-box;">
                              <td class="card-content" style="box-sizing: border-box; font-size: 13px; line-height: 20px; color: rgb(111, 119, 125); padding-top: 10px; padding-right: 20px; padding-bottom: 0px; padding-left: 20px; vertical-align: top;" valign="top">
                                <h1 class="card-title" style="box-sizing: border-box; font-size: 25px; font-weight: 300; color: rgb(68, 68, 68);">Hi, @FIRSTNAME
                                </h1>
                                <p class="card-text" style="box-sizing: border-box;">Welcome to @PORTAL, your email are registered as Member of the LMS Portal. Please click the link bellow to verify your account and continue the registration step.
                                </p>
